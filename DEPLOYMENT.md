...
This repository includes a `render.yaml` file, which enables automatic service setup.
1. Sign in to the [Render Dashboard](https://dashboard.render.com/).
2. Click **New +** and select **Blueprint**.
3. Connect your GitHub repository.
4. Render will automatically detect `render.yaml` and configure a Web Service named `agentbridge-backend`.
5. Enter the values for the following environment variables:
